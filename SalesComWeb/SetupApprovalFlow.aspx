<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/default.master" AutoEventWireup="true" CodeFile="SetupApprovalFlow.aspx.cs" Inherits="SetupActivity" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="Content">
        ...
        <div style="text-align: right">
            <input type="button" value="Add New" alt="SetupApprovalFlowAdd.aspx?keepThis=false&TB_iframe=true&height=300&width=450"
                class="thickbox" title="Approval Flow Add" />
        </div>
        <% }
           else
           { %>
                    ...
                    <asp:ListView ID="lv" runat="server" ItemPlaceholderID="item" SkinID="ListviewSkin">
                        ...
                        <ItemTemplate>
                            <tr class='<%# Container.DataItemIndex % 2 == 0 ? "row" : "altrow" %>'>
                                ...
                                <td style="text-align: center">
                                    <a type="button" href="SetupApprovalFlowAdd.aspx?id= <%#Eval("ApprovalFlowID")%>&mode=edit&TB_iframe=true&height=300&width=450"
                                        class="thickbox" title="Approval Flow MODIFY">Edit</a>
                                </td>
