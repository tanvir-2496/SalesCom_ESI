<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/default.master" AutoEventWireup="true" CodeFile="SetupCommissionCycle.aspx.cs" Inherits="SetupActivity" %>
    ...
    <div class="Content">
        ...
        <div style="text-align: right">
            <input type="button" value="Add New" alt="SetupCommissionCycleAdd.aspx?keepThis=false&TB_iframe=true&height=300&width=450"
                class="thickbox" title="Commission Cycle Add" />
        </div>
        <% }
          %>
                    ...
                    <asp:ListView ID="lv" runat="server" ItemPlaceholderID="item" SkinID="ListviewSkin">
                        ...
                        <ItemTemplate>
                            <tr class='<%# Container.DataItemIndex % 2 == 0 ? "row" : "altrow" %>'>
                                ...
                                <td>
                                    <%#Common.DateFormat(Eval("PeriodStartDate")) %>&nbsp
                                </td>

                                <td>
                                    <%#Common.DateFormat(Eval("PeriodEndDate")) %>&nbsp
                                </td>
                                <td>
                                    <%#Common.ProcessBoolData(Eval("CycleStatusId")) %>&nbsp
                                </td>

                                <td style="text-align: center">
                                    <a type="button" href="SetupCommissionCycleAdd.aspx?id= <%#Eval("CycleId")%>&mode=edit&TB_iframe=true&height=300&width=450"
