<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/default.master" AutoEventWireup="true" CodeFile="ReportView.aspx.cs" Inherits="PendingApproval" %>
    ...
    <script type="text/javascript">
        ...
        function GetReportNameList() {
            ...
            $.ajax({
                ...
                url: "ReportView.aspx/GetReportName",
                data: "{}",
                dataType: "json",
            ...
            <ContentTemplate>
                ...
                <div>
                    ...
                    <div style="float: right; padding: 5px;">
                        <a class="tooltip" href="#">Report Quick Facts<span class="classic">XYZ_C - COUNT<br />
                            XYZ_A - AMOUNT</span></a>
                    </div>
                </div>
                        ...
                        <asp:ListView ID="lv" runat="server" ItemPlaceholderID="item" SkinID="ListviewSkin" OnItemCommand="lv_ItemCommand" OnItemDataBound="lv_ItemDataBound">
                            ...
                            <ItemTemplate>
                                ...
                                <tr class='<%# Container.DataItemIndex % 2 == 0 ? "row" : "altrow" %>'>
                                    ...
                                    <%#Convert.ToString(Eval("LevelName")) == "Being processed ..." ? Eval("LevelName", "<td  style='color:#3768A0; font-weight: bold; text-align: center' ><b>{0}</b></td>") : Eval("LevelName", "<td style='text-align: center'>{0}</td>")%>
                                    <td style="text-align: right">
                                        <%#Eval("TotalAmount")%>&nbsp;
                                    </td>

                                    <td style="text-align: center">
                                        <asp:LinkButton ID="lbtnDetailsAmount" runat="server" CommandName="DetailsAmount" CommandArgument='<%#Eval("CycleReportID")%>' Text="Detail" />
                                    </td>

                                    <td style="text-align: center">
                                        <a type="button" href="PendingApprovalSummaryView.aspx?id=10&CycleID=<%#Eval("CycleReportId")%>&TB_iframe=true&height=500&width=750"
