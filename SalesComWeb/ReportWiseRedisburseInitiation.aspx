<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Modal.master" CodeFile="ReportWiseRedisburseInitiation.aspx.cs" Inherits="ReportWiseRedisburseInitiation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="position: relative">
        <div style="right: 0; position: absolute; top: 0">
            <asp:Button ID="btnDownloadSample" runat="server" SkinID="btnCommonSkin" Text="Template" OnClick="btnDownloadSample_Click" />
        </div>
        <table class="contenttext" style="width: 100%;">
            ...
            <tr>
                <th>
                    <asp:Label ID="lblWitheld" runat="server" Text="Withheld Amt:" SkinID="lblSmallSkin"> </asp:Label>
                    <asp:Label ID="lblWithheldAmount" runat="server" Font-Names="verdana" Font-Size="Small"> </asp:Label>
                </th>
            </tr>
        </table>
    </div>
                    ...
                    <table class="contenttext" style="width: 100%;">
                        <tr>
                            <th>
                                ...
                                <asp:FileUpload ID="fuExcelFiles" runat="server" type="file" />
                            </th>
                        </tr>
                        <tr>
                            <td>
                ...
                <asp:Panel ID="plImport" runat="server" Visible="false">
                    <table class="contenttext" style="width: 100%;">
                        <tr>
                            <td>
                                <div>
                                    <asp:Label ID="Label5" runat="server" Text="File Name:" SkinID="lblSmallSkin" />
                    ...
                    <table class="contenttext" style="width: 100%;">
                        ...
                        <tr>
                            <th>
                                ...
                                <asp:Button ID="btnSubmit" runat="server" Text="Submit" OnClick="btnSubmit_Click" SkinID="btnCommonSkin" OnClientClick="this.disabled=true;" UseSubmitBehavior="false" Visible="false" />
