<%@ Page Language="C#" MasterPageFile="~/MasterPages/Modal.master" AutoEventWireup="true" CodeFile="CommissionApprovalProcess.aspx.cs" Inherits="CommissionApprovalProcess" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="contenttext" style="width: 100%">
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="lblBaseCycle" runat="server" Text=""></asp:Label>
            </td>
        </tr>
