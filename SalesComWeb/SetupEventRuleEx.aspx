<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/default.master" AutoEventWireup="true" CodeFile="SetupEventRuleEx.aspx.cs" Inherits="SetupEventRule" %>
                    ...
                    <asp:ListView ID="lv" runat="server" ItemPlaceholderID="item" SkinID="ListviewSkin">
                        ...
                        <ItemTemplate>
                            <tr class='<%# Container.DataItemIndex % 2 == 0 ? "row" : "altrow" %>'>
                                ...
                                <%--<%#Convert.ToInt32(Eval("UserId")) == LoginInfo.Current.UserId ? String.Format("<td style='text-align: center'><a type='button' href='EventRuleApprovalPage.aspx?id={0}&mode=edit&TB_iframe=true&height=400&width=500' class='thickbox' title='Event Rule Approval'>Approval</a></td>", Eval("EVENTRULEID")) : "<td>Not Authorized</td>" %>--%>
                               <%--  <td style="text-align: center">
                                    <a type="button" href="EventRuleApprovalPage.aspx?id= <%#Eval("EVENTRULEID")%>&mode=edit&TB_iframe=true&height=400&width=500"
                                        class="thickbox" title="Event Rule Approval">Approval</a>
                                </td>--%>
                               
                                
                                 <%#(Convert.ToInt16(Eval("STATUS")) == 0 || Convert.ToInt16(Eval("STATUS")) == 4)  ? String.Format("<td style='text-align: center'> <a type='button' href='SetupEventRuleExAdd.aspx?id={0}&mode=edit&TB_iframe=true&height=400&width=500' class='thickbox' title='Event Ex Modify'>Edit</a></td>", Eval("EVENTRULEID")) : "<td>Not Editable</td>" %>
                            </tr>
                        </ItemTemplate>
                    </asp:ListView>
                </div>
