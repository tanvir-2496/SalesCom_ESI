<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/default.master" AutoEventWireup="true" CodeFile="SetupChannelEventBatch.aspx.cs" Inherits="SetupActivity" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    </script><div class="leftPanel"></div>
    <div class="Content">
        ...
        <div style="text-align: right">
            <input type="button" value="Add New" alt="SetupChannelEventBatchAdd.aspx?keepThis=false&TB_iframe=true&height=300&width=450"
                class="thickbox" title="Channel Event Batch Add" />
        </div>
        <% }%>
                    ...
                    <asp:ListView ID="lv" runat="server" ItemPlaceholderID="item" SkinID="ListviewSkin">
                        ...
                        <ItemTemplate>
                            <tr class='<%# Container.DataItemIndex % 2 == 0 ? "row" : "altrow" %>'>
                                ...
                                <td>
                                    <%#Convert.ToDateTime(Eval("BatchDate")).ToString("dd-MMM-yyyy")%>&nbsp;
                                </td>
                                <td>
                                    <%#Eval("IsReady")%>&nbsp;
                                </td>
                                ...
                                <td style="text-align: center">
                                    <a type="button" href="SetupChannelEventBatchAdd.aspx?id= <%#Eval("ChannelEventBatchId")%>&mode=edit&TB_iframe=true&height=300&width=450"
                                        class="thickbox" title="Channel Event Batch MODIFY">Edit</a>
                                </td>
