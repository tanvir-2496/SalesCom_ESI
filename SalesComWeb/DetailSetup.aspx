...
<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/default.master" AutoEventWireup="true" CodeFile="DetailSetup.aspx.cs" Inherits="DetailSetup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="Content">
        ...
        <div style="text-align: right">
            <input type="button" value="Add New" alt="DetailSetUpAdd.aspx?keepThis=false&TB_iframe=true&height=400&width=600"
                class="thickbox" title="Detail Setup Add" />
        </div>
        <% }
           else
           { %>
                    ...
                    <asp:ListView ID="lv" runat="server" ItemPlaceholderID="item" SkinID="ListviewSkin">
                        <LayoutTemplate>
                            <table class="datatable" cellpadding="0" cellspacing="0" border="0px">
                                ...
                                <thead>
                                    <tr class="gridheader">
                                        <th>#</th>
                                        <th style="text-align: left; padding-left: 3px">Report Name</th>
                                        <th>Month Name</th>
                                        <th>Total Details</th>
                                        <th>Edit</th>
                        ...
                        <ItemTemplate>
                            <tr class='<%# Container.DataItemIndex % 2 == 0 ? "row" : "altrow" %>'>
                                ...
                                <td style="text-align: center">
                                    <a type="button" href="DetailSetupAdd.aspx?id= <%#Eval("Id")%>&mode=edit&TB_iframe=true&height=400&width=600"
                                        class="thickbox" title="Detail Setup Modify">Edit</a>
                                </td>
