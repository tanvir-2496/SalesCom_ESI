<%@ Page Language="C#" MasterPageFile="~/MasterPages/Modal.master" AutoEventWireup="true" CodeFile="InitiateDisburseSubmit.aspx.cs" Inherits="InitiateClaimSubmit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="position: relative">
        ...
        <table class="contenttext" style="width: 100%;">
            ...
            <tr>
                <th>
                    <asp:Label ID="lblClaim" runat="server" Text="Claim :" SkinID="lblSmallSkin"> </asp:Label>
                    <asp:Label ID="lblClaimAmount" runat="server" Font-Names="verdana" Font-Size="Small"> </asp:Label>
                </th>
            </tr>
        </table>
    </div>
            ...
            <div>
                <asp:Panel ID="plClaimProcess" runat="server">
                    <table class="contenttext" style="width: 100%;">
                        ...
                        <tr>
                            <th>
                                <asp:Label ID="lblHashInput" runat="server" Text="Has Withheld List? :" SkinID="lblCommonSkin" />
