<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Modal.master" AutoEventWireup="true" CodeFile="SetupEventRuleAdd.aspx.cs" Inherits="SetupEventRuleAdd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="upReport" runat="server">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtEventRuleName" CssClass="required" runat="server" SkinID="txtCommonSkin"  onkeypress="return IsAlphaNumeric(event)" MaxLength="25"></asp:TextBox>
            </td>
        </tr>
        ...
        <tr>
            <td>
                <asp:Label ID="lblMaxCommissionPerevent" mandatory="true" runat="server" Text="Max Commission Percent"> </asp:Label>
            </td>
            <td>
