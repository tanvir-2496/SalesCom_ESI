<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/default.master" AutoEventWireup="true" CodeFile="SetupEventEx.aspx.cs" Inherits="SetupActivity" %>
        ...
        <asp:UpdatePanel ID="lstpanel" runat="server">
            <ContentTemplate>
                <div>
                    <table>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <asp:Button ID="btnSearch" CssClass="button" runat="server" Text="Search..." SkinID="btnCommonSkinLarge" OnClick="btnSearch_Click" /></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>
                ...
                <div style="text-align: right">
                    <input type="button" value="Add New" alt="SetupEventExAdd.aspx?keepThis=false&TB_iframe=true&height=300&width=450"
                    ...
                    <asp:ListView ID="lv" runat="server" ItemPlaceholderID="item" SkinID="ListviewSkin">
                        ...
                        <ItemTemplate>
                            <tr class='<%# Container.DataItemIndex % 2 == 0 ? "row" : "altrow" %>'>
                                ...
                                <%#Convert.ToInt16(Eval("LEVELUSERID")) == LoginInfo.Current.UserId ? String.Format("<td style='text-align: center'> <a type='button' href='SetupEventExAdd.aspx?id={0}&mode=edit&TB_iframe=true&height=300&width=450' class='thickbox' title='Event ADD/MODIFY'>Edit</a></td>", Eval("EVENTID")) : "<td>Not Permitted</td>" %>
                                ...
                                <%#Convert.ToInt16(Eval("STATUS")) == 0 ? String.Format("<td style='text-align: center'> <a type='button' href='SetupEventExAdd.aspx?id={0}&mode=edit&TB_iframe=true&height=300&width=450' class='thickbox' title='Event Modify'>Edit</a></td>", Eval("EVENTID")) : "<td>Not Editable</td>" %>
                            </tr>
                        </ItemTemplate>
                    </asp:ListView>
                </div>
