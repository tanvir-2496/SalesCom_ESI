<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Modal.master" AutoEventWireup="true" CodeFile="PendingApprovalView.aspx.cs" Inherits="PendingApprovalView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="contenttext" width="100%">
        ...
        <tr>
            <td>
                <asp:Label ID="Label5" runat="server" Text="Base Cycle : " SkinID="lblCommonSkin"></asp:Label>
            </td>
            <td>
