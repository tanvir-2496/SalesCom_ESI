<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/default.master" AutoEventWireup="true" CodeFile="SetupEventType.aspx.cs" Inherits="SetupActivity" %>
    ...
    <div class="Content">
       ...
       <% if (Permissions.EventTypeAdd)
        ...
        <div style="text-align: right">
            <input type="button" value="Add New" alt="SetupEventTypeAdd.aspx?keepThis=false&TB_iframe=true&height=300&width=450"
                class="thickbox" title="Event Type Add" />
        </div>
       <% }%>
                    ...
                    <asp:ListView ID="lv" runat="server" ItemPlaceholderID="item" SkinID="ListviewSkin">
                        ...
                        <ItemTemplate>
                            <tr class='<%# Container.DataItemIndex % 2 == 0 ? "row" : "altrow" %>'>
                                ...
                                <td style="text-align: center">
                                    <a type="button" href="SetupEventTypeAdd.aspx?id= <%#Eval("EventTypeId")%>&mode=edit&TB_iframe=true&height=300&width=450"
                                        class="thickbox" title="Event Type Modify">Edit</a>
                                </td>
