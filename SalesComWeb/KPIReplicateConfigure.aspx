<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/default.master" AutoEventWireup="true" CodeFile="KPIReplicateConfigure.aspx.cs" Inherits="SetupKpiConfigure" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <ContentTemplate>
                <div>
                    ...
                    <div class="hideClass" style="float: left; margin-left: 2%">
                        <table>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:DropDownList ID="ddlMonth" runat="server" SkinID="ddlCommonSkin" CssClass="required" ClientIDMode="Static" onchange="SalesGroupValidation()">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                        ...
                        <table style="min-width: 410px; margin-left: 10px; margin-top: 30px; margin-right: auto;" class="table display responsive nowrap table-bordered mg-b-0 bl-border line-item-table" id="tblLineItemList">

                            <thead class="thead-colored">
                                <tr>
                                    <th style="display: none">S.L.</th>
                                    <th style="max-width: 15px !important;">Check</th>
                                    <th>KPI</th>
                                </tr>
                            </thead>
                    ...
                    <div class="hideClass" style="float: right; margin-right: 30px">
                        <table>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="lblCloneSalesGroup" SkinID="lblCommonSkin" runat="server" Text="Replicate Sales Group"> </asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddlCloneSalesGroup" runat="server" SkinID="ddlCommonSkin" CssClass="required" OnSelectedIndexChanged="ddlCloneSalesGroup_SelectedIndexChanged" AutoPostBack="true">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="lblCloneSalesChannelName" SkinID="lblCommonSkin" runat="server" Text="Replicate Sales Channel"> </asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddlCloneSalesChannelName" runat="server" SkinID="ddlCommonSkin">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="lblCloneYear" SkinID="lblCommonSkin" runat="server" Text="Replicate Year"> </asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddlCloneYear" runat="server" SkinID="ddlCommonSkin">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="lblCloneQuarter" SkinID="lblCommonSkin" runat="server" Text="Replicate Quarter"> </asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddlCloneQuarter" runat="server" SkinID="ddlCommonSkin">
                                        <asp:ListItem Text="[Select One]" Value="0"></asp:ListItem>
                                        <asp:ListItem Text="Q1" Value="1"></asp:ListItem>
                                        <asp:ListItem Text="Q2" Value="2"></asp:ListItem>
                                        <asp:ListItem Text="Q3" Value="3"></asp:ListItem>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="lblConeMonth" SkinID="lblCommonSkin" runat="server" Text="Replicate Month"> </asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddlCloneMonth" runat="server" SkinID="ddlCommonSkin">
                                        <asp:ListItem Text="[Select One]" Value="0"></asp:ListItem>
                            ...
                            <tr>
                                ...
                                <td class="tdSubmit" colspan="2">
                                    <asp:Button ID="btnSave" Style="width: 120px !important;" OnClientClick="return OperationalValidation();" runat="server" Text="KPI Replicate" SkinID="btnCommonSkin" />
    ...
    <script type="text/javascript">
        ...
        function OperationalValidation() {
            ...
            var CloneReportType = $('#<%=ddlCloneReportType.ClientID %> option:selected').val();
            var CloneSalesGroup = $('#<%=ddlCloneSalesGroup.ClientID %> option:selected').val();
            var CloneSalesChannelName = $('#<%=ddlCloneSalesChannelName.ClientID %> option:selected').val();
            ...
            if (CloneSalesChannelName == "" || CloneSalesChannelName == "0") {
                $("span[id$=lblMsg]").html("<b>Please select replicate sales channel</b><br>").css("color", "red");
                isAllValid = false;
                return false;
            }
            ...
            if ((Month != "" && Month != "0" && typeof (Month) != "undefined") && (CloneMonth == "" || CloneMonth == "0")) {
                $("span[id$=lblMsg]").html("<b>Please select replicate month</b><br>").css("color", "red");
                isAllValid = false;
                return false;
            }

            //Is all valid then check checkbox select

            if (isAllValid) {

                var checkValue = [];
                $(".kpi_chkbox:checked").each(function () {
        ...
        function CallToAjaxCall() {
            var KPIItem = "";
            var ToReportType = $('#<%=ddlCloneReportType.ClientID %> option:selected').val();
            var ToSalesGroup = $('#<%=ddlCloneSalesGroup.ClientID %> option:selected').val();
            var ToSalesChannelName = $('#<%=ddlCloneSalesChannelName.ClientID %> option:selected').val();
            var ToYear = $('#<%=ddlCloneYear.ClientID %> option:selected').val();
            var ToQuarter = $('#<%=ddlCloneQuarter.ClientID %> option:selected').val();
            var ToMonth = $('#<%=ddlCloneMonth.ClientID %> option:selected').val();

            var FromSalesGroup = $('#<%=ddlSalesGroup.ClientID %> option:selected').val();
            var FromYear = $('#<%=ddlYear.ClientID %> option:selected').val();
            var FromQuarter = $('#<%=ddlQuarter.ClientID %> option:selected').val();
            var FromReportName = $('#<%=ddlReportName.ClientID %> option:selected').val();
            var FromMonth = $('#<%=ddlMonth.ClientID %> option:selected').val();

            var checkValue = [];
            $(".kpi_chkbox:checked").each(function () {
                //checkValue.push(this.value);
                if (KPIItem != "") {
                    KPIItem = KPIItem + "," + this.value;
                } else {
                    KPIItem = this.value;
                }
            });
            ...
            getFromItem.FromSalesGroup = FromSalesGroup;
            getFromItem.FromYear = FromYear;
            getFromItem.FromQuarter = FromQuarter;
            getFromItem.FromReportName = FromReportName;
            getFromItem.FromMonth = FromMonth;
            ...
            getToItem.ToReportType = ToReportType;
            getToItem.ToSalesGroup = ToSalesGroup;
            getToItem.ToSalesChannelName = ToSalesChannelName;
            getToItem.ToYear = ToYear;
            getToItem.ToQuarter = ToQuarter;
            getToItem.ToMonth = ToMonth;

            dataToItem.push(getToItem);

            DataSaveAjaxCall(dataFromItem, dataToItem, KPIItem);

        }

        function DataSaveAjaxCall(dataFromItem, dataToItem, KPIItem) {
            var Data = JSON.stringify({ dataFromItem: dataFromItem, dataToItem: dataToItem, KPIItem: KPIItem });

            $.ajax({

                url: "KPIReplicateConfigure.aspx/SaveReplicateData",
                data: Data,
                type: "POST",
                dataType: "json",
                ...
                success: function (data) {
                    ...
                    if (data.d == "SUCCESSFUL" || data.d == "SUCCE") {
                             $("span[id$=lblMsg]").html("<b>KPI data process successfully replicate.</b><br>").css("color", "green");
                             DataClear();
                         return false;
                     } else {
        ...
        function DataClear() {
            $("#<%=ddlCloneMonth.ClientID%>").attr("disabled", false);
            $('#<%=ddlSalesGroup.ClientID %>').val(0);
            $('#<%=ddlYear.ClientID %>').val(2022);
            $('#<%=ddlQuarter.ClientID %>').val(0);
            $('#<%=ddlReportName.ClientID %>').empty();
            $('#<%=ddlMonth.ClientID %>').empty();

            $('#<%=ddlCloneReportType.ClientID %>').val(3);
            $('#<%=ddlCloneSalesGroup.ClientID %>').val(0);
            $('#<%=ddlCloneSalesChannelName.ClientID %>').empty();
            $('#<%=ddlCloneYear.ClientID %>').val(2022);
            $('#<%=ddlCloneQuarter.ClientID %>').val(0);
            $('#<%=ddlCloneMonth.ClientID %>').val(0);
            $(".dummy_row_line_item").remove();

        }

        function MonthlyEnableDisable() {
            debugger;
            // $("#ContentPlaceHolder1_ddlCloneMonth").attr("disabled", false);
            $("#<%=ddlCloneMonth.ClientID%>").attr("disabled", false);
            var monthValue = $('#<%=ddlMonth.ClientID %> option:selected').val();

            if (monthValue == "0") {
                $('#<%=ddlCloneMonth.ClientID %>').val(0);
                $("#<%=ddlCloneMonth.ClientID%>").attr("disabled", true);
            }
            
        }

        function SalesGroupValidation() {
            MonthlyEnableDisable();
            debugger;
            var rowSL = 0;
            var reportValue = $('#<%=ddlReportName.ClientID %> option:selected').val();
            var monthValue = $('#<%=ddlMonth.ClientID %> option:selected').val();
            $(".dummy_row_line_item").remove();
            if (reportValue != "" && reportValue != "0" && monthValue != "") {
           // if (reportValue != "" && reportValue != "0" && monthValue != "" && monthValue != "0") {
                var Data = JSON.stringify({ reportId: reportValue, monthid: monthValue });
                $.ajax({
                    url: "KpiConfigure.aspx/GETSalesKPI",
                    data: Data,
                    type: "POST",
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    success: function (mydata) {
                        $.each(mydata.d, function () {
                            debugger;
                            var tableRow = "<tr class='dummy_row_line_item' id='kpi_" + (rowSL + 1) + "'>";
                            var int = 0;

                            tableRow = tableRow + "<td class='dummy_sl_no' style='display: none'> <span>" + (rowSL + 1) + " </span></td>";
                            tableRow = tableRow + "<td class='dummy_item_checkbox'><input type='checkbox' class='kpi_chkbox' name='" + this.kpi_id + "' value='" + this.kpi_id + "'>";
                            tableRow = tableRow + "<td class='dummy_item_kpi'><input type='hidden' name='Channel[" + (rowSL) + "].Group' value='" + this.kpi_id + "'> <span>" + this.kpi_name + "</span></td>";
    ...
    function loadCloneSalesChannelByGroup() {
        debugger;
        var sCloneGroup = $('#<%=ddlCloneSalesGroup.ClientID %> option:selected').val();
            if (sCloneGroup == "0") {
                alert("Please Select Sales Group");
                $('#<%=ddlCloneSalesChannelName.ClientID%>').empty();
            return;
        ...
        var Data = JSON.stringify({ SalesGroupId: sCloneGroup });
        $.ajax({
            url: "KPIReplicateConfigure.aspx/GETSalesChannelByGROUPID",
            data: Data,
            type: "POST",
            dataType: "json",
            contentType: "application/json; charset=utf-8",
            success: function (mydata) {
                ...
                $('#<%=ddlCloneSalesChannelName.ClientID%>').empty();
                $.each(mydata.d, function () {
                    $('#<%=ddlCloneSalesChannelName.ClientID%>').append("<option value=" + this.Sales_Channel_Id + ">" + this.Sales_Channel_Name + "</option>");
                });
            }
        });
    }
