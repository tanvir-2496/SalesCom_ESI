<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/default.master" AutoEventWireup="true" CodeFile="SetupReportReplication.aspx.cs" Inherits="SetupActivity" %>
                        ...
                        <ItemTemplate>
                            <tr class='<%# Container.DataItemIndex % 2 == 0 ? "row" : "altrow" %>'>
                                ...
                                <td style="text-align: center">
                                    ...
                                    <%if (Permissions.CommissionReportCopyModify)
                                      { %>
                                    <a type="button" href="SetupCommissionReportConciseAdd.aspx?id= <%#Eval("ReportId")%>&mode=edit&TB_iframe=true&height=400&width=450"
                                        class="thickbox" title="Modify Report">Edit</a>
                                    <%} %>
                                    <%else
                                      { %>

                                    <a type="button" href="#">Unauthorized to Edit</a>
                                    <%} %>
                                ...
                                <td style="text-align: center">
                                    <%if (Permissions.CommissionReportCopyAdd)
                                      { %>
                                    <a type="button" href="SetupReportReplicationAdd.aspx?id= <%#Eval("ReportId")%>&mode=edit&TB_iframe=true&height=400&width=450"
                                        class="thickbox" title="Replicate Report">Replicate</a>
                                    <%} %>
                                    <%else
                                      {%>
                                    <a type="button" href="#">Unauthorized to Add</a>
                                    <%} %>
