<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Modal.master" AutoEventWireup="true" CodeFile="ReportApprovalAct.aspx.cs" Inherits="ReportApprovalAct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="contenttext" style="width: 100%">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtComments" MaxLength="10" onkeyDown="return checkTextAreaMaxLength(this,event,'300');" runat="server" TextMode="MultiLine" Height="40" Width="385px"></asp:TextBox>
            </td>
        </tr>
