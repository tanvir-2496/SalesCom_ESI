<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Modal.master" AutoEventWireup="true" CodeFile="KpiApprovalAct.aspx.cs" Inherits="KpiApprovalAct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="contenttext" style="width: 100%">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtComments" MaxLength="300" onkeyDown="return checkTextAreaMaxLength(this,event,'300');" runat="server" TextMode="MultiLine" Height="40" Width="385px"></asp:TextBox>
            </td>
        </tr>
...
<%--<script type="text/javascript">
        $(document).ready(function () {
            $(".MultiLineLimit").on('change keydown paste input', function () {
                this.value = (this.value.length <= 300 ? this.value : this.value.substring(0, 300));
            });
        });
    </script>--%>
</asp:Content>
