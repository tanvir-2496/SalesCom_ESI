<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/default.master" AutoEventWireup="true" CodeFile="SetupSimValidationRule.aspx.cs" Inherits="SetupActivity" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="Content">
        ...
        <div style="text-align: right">
            <input type="button" value="Add New" alt="SetupSimValidationRuleAdd.aspx?keepThis=false&TB_iframe=true&height=300&width=450"
                class="thickbox" title="SIM Validation Rule Add" />
        </div>
        <% }%>
                        ...
                        <ItemTemplate>
                            <tr class='<%# Container.DataItemIndex % 2 == 0 ? "row" : "altrow" %>'>
                              ...
                              <input type="checkbox" disabled="true" <%#Eval("ACTIVEYN").ToString()=="Y"?"checked":"" %> />
                                ...
                                <td style="text-align: center">
                                    <a type="button" href="SetupSimValidationRuleAdd.aspx?id= <%#Eval("ValidationRuleId")%>&mode=edit&TB_iframe=true&height=300&width=450"
                                        class="thickbox" title="SIM Validation Rule Modify">Edit</a>
                                </td>
