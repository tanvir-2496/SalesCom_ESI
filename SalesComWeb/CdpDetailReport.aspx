<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/default.master" AutoEventWireup="true" CodeFile="CdpDetailReport.aspx.cs" Inherits="CdpDetailReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <%--<asp:UpdatePanel ID="upCycle" runat="server">--%>
            <%--<ContentTemplate>--%>
                <table style="width: 350px;">
                    <tr>
                        <td>
                            <asp:Label ID="lblStarGererationDate" runat="server" Text="Date From" mandatory="true" SkinID="lblCommonSkin"> </asp:Label>
                        </td>
                        <td>
    ...
    <script type="text/javascript">
        ...
        $("#btnReport").click(function (e) {
            ...
            if (txtFromDate == "") {
                e.preventDefault();
                alert("Please Enter Date Form");
            }
            else if (txtToDate == "") {
                e.preventDefault();
                alert("Please Enter To  Date");
            }
            else if (ddlReportname == -1) {
                e.preventDefault();
