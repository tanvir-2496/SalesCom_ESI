<%@ Page Language="C#" MasterPageFile="~/MasterPages/Modal.master" AutoEventWireup="true" CodeFile="ClaimApprovalAction.aspx.cs" Inherits="CommissionApprovalProcess" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="contenttext" style="width: 100%">
        ...
        <tr>
            <th>
                <asp:Label ID="Label1" runat="server" Text="Discard:"></asp:Label>
            </th>
            <td>
                <asp:Label ID="lblDiscard" runat="server" Text=""></asp:Label>
            </td>
        </tr>

        <tr>
            <th>
                <asp:Label ID="Label6" runat="server" Text="Claim:"></asp:Label>
            </th>
            <td>
