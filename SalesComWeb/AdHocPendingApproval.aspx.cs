...
public partial class PendingApproval : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            if (!Permissions.AdhocPendingApprovalView)
            {
    ...
    {
        List<AdHocPendingApprovalEnt> list = AdHocPendingApprovalDAL.GetItemList(0, LoginInfo.Current.UserId, startDate, endDate);
        lv.DataSource = list;
        lv.DataBind();
