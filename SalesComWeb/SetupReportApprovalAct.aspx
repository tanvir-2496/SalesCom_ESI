<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Modal.master" AutoEventWireup="true" CodeFile="SetupReportApprovalAct.aspx.cs" Inherits="SetupReportApprovalAct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="contenttext" style="width: 100%">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtComments" runat="server" TextMode="MultiLine" Height="40" Width="385px"></asp:TextBox>
            </td>
