<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/default.master" AutoEventWireup="true" CodeFile="InitiateDisburseApproval.aspx.cs" Inherits="PendingApproval" %>
                    ...
                    <asp:ListView ID="lv" runat="server" ItemPlaceholderID="item" SkinID="ListviewSkin" OnItemCommand="lv_ItemCommand" OnItemDataBound="lv_ItemDataBound">
                        ...
                        <ItemTemplate>
                            ...
                            <tr class='<%# Container.DataItemIndex % 2 == 0 ? "row" : "altrow" %>'>
                                ...
                                <%# Convert.ToInt16(Eval("order_id")) == 1 ? String.Format("<td style='text-align: center'><a type='button' href='InitiateDisburseSubmit.aspx?RCID={0}&RN={1}&CA={2}&RD={3}&RF={4}&TB_iframe=true&height=550&width=750'class='thickbox' title='Disburse Initiation'>Disburse</a></td>", Eval("REPORT_CYCLE_ID"), Eval("REPORT_NAME"), Eval("CLAIM_AMOUNT"), Eval("REPORT_DURATION"), Eval("FLOW_ID")) : "<td style='text-align:center'> Under Process </td>"  %>
                                <% }
                                   else
                                   { %>
