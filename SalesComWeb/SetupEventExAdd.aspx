<%@ Page Title="Event" Language="C#" MasterPageFile="~/MasterPages/Modal.master" AutoEventWireup="true" CodeFile="SetupEventExAdd.aspx.cs" Inherits="SetupActivityAdd" Culture="en-GB" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table class="contenttext" style="width: 100%;">
        ...
        <%-- <tr>
            <td>
                <asp:Label ID="lblApprovalFlowChain" runat="server" Text="Approval Chain" mandatory="true"> </asp:Label>
            </td>
            <td>
                <asp:DropDownList ID="ddlApprovalFlowName" runat="server" SkinID="ddlCommonSkin" CssClass="required"></asp:DropDownList>
            </td>
        </tr>--%>
