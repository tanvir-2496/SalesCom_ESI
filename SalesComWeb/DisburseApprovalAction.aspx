<%@ Page Language="C#" MasterPageFile="~/MasterPages/Modal.master" AutoEventWireup="true" CodeFile="DisburseApprovalAction.aspx.cs" Inherits="CommissionApprovalProcess" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="contenttext" style="width: 100%">
        ...
        <tr>
            <th>
                <asp:Label ID="lblClaim" runat="server" Text="Claim:"></asp:Label>
            </th>
            <td>
         ...
         <tr>
            <th>
                <asp:Label ID="lblDisburse" runat="server" Text="Disburse:"></asp:Label>
            </th>
            <td>
                <asp:Label ID="lblDisburseAmount" runat="server" Text=""></asp:Label>
            </td>
        </tr>
