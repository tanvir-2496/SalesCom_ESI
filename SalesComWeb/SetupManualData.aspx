<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/default.master" AutoEventWireup="true" CodeFile="SetupManualData.aspx.cs" Inherits="SetupManualData" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="Content">
        <div style="text-align: right">
            <input type="button" value="Add KPI Header" alt="SetupAddKPIHeader.aspx?keepThis=true&TB_iframe=true&height=250&width=450"
                            class="thickbox" title="Add KPI Header" />
            <input type="button" value="Disable KPI Header" alt="DisableKPIHeader.aspx?keepThis=false&TB_iframe=true&height=400&width=500"
                            class="thickbox" title="Disable KPI Header" />
        ...
        <asp:UpdatePanel ID="upReportname" runat="server">
            <ContentTemplate>
                <table class="contenttext" style="width: 100%;">
                    <tr>
                        <td>
                            <asp:Label ID="Label6" runat="server" Text="Year" SkinID="lblCommonSkin" mandatory="true"></asp:Label>

                            <asp:DropDownList ID="ddlYear" runat="server" AutoPostBack="true"  SkinID="ddlCommonSkin" CssClass="required" ClientIDMode="Static">
                            </asp:DropDownList>
                        </td>
                    </tr>
                     <tr>
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:DropDownList ID="ddlQuarter" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddl_Quarter_IndexChanged"  SkinID="ddlCommonSkin" CssClass="required" ClientIDMode="Static">
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:DropDownList ID="ddlMonth" runat="server" AutoPostBack="true" SkinID="ddlCommonSkin" CssClass="required" ClientIDMode="Static">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label4" runat="server" Text="Data Type" SkinID="lblCommonSkin" mandatory="true"></asp:Label>
                            <asp:DropDownList ID="ddlDataType" runat="server" AutoPostBack="true"  SkinID="ddlCommonSkin" CssClass="required" ClientIDMode="Static">
                            </asp:DropDownList>
                        </td>
                    </tr>
            ...
            <tr>
                <asp:Panel ID="Panel2" runat="server" Visible="false">
                    <td>
                        ...
                        <br />
                        <div>
                            <asp:Label ID="lblImageTypeFileUpLoad" runat="server" Text="Calculation Attachment" SkinID="lblCommonSkin"> </asp:Label>
