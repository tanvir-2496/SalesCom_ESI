...
namespace SalesCom.Entity
{
    public class ReportPreExeConfigEnt
    {
        ...
        public DateTime ComMatureDate { get; set; }
        ...
        public ReportPreExeConfigEnt(DataRow dr)
        {
            ...
            if (dr["MATURE_DATE"] != DBNull.Value) { this.MatureDate = Convert.ToDateTime(dr["MATURE_DATE"]); }
            if (dr["COM_MATURE_DATE"] != DBNull.Value) { this.ComMatureDate = Convert.ToDateTime(dr["COM_MATURE_DATE"]); }
            this.LateReason = dr["LATE_REASON"] as String;
        }
    }
}
