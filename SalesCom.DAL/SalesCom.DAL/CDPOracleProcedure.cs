...
{
   public class CDPOracleProcedure
    {
        ...
        public CDPOracleProcedure(string procedureName)
        {
        ...
        public void ExecuteNonQuery(CdpDbTransaction transaction)
        {
            if (transaction == null)
            {
                ExecuteNonQuery();
