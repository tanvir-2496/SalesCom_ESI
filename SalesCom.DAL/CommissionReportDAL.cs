...
namespace SalesCom.DAL
{
    ...
    {
        public static List<string> Get_Detail_Report_Name_List(int Id)
        {
            OracleProcedure procedure = new OracleProcedure(Utility.GetSchemaSetup(), "Get_Detail_Report_Name_List");
            ...
            try
            {
                ...
                {
                    results.Add(dr["REPORT_NAME"] as string);
                }
        ...
        public static List<string> Get_Report_Name_By_YearMonth(int yearMonth)
        {
            OracleProcedure procedure = new OracleProcedure(Utility.GetSchemaSetup(), "Get_Report_Name_By_YearMonth");
            procedure.AddInputParameter("pYearMonth", yearMonth, OracleType.Number);
        ...
        public static int SaveItem(CommissionReportConciseEnt obj, string strMode)
        {
            ...
            // Addition
            procedure.AddInputParameter("pSrfUploadId", obj.SrfUploadId, OracleType.Number);
            // end addition
            try
            {
        ...
        public static int SaveItemWithFile(CommissionReportConciseEnt obj, string strMode, int userId)
        {
            ...
            if (obj.SRContent != null && obj.SRContent.Length > 0)
            {
                ...
                string updateReportSetup = String.Empty;
