...
namespace SalesCom.DAL
{
    ...
    {
        public static DataTable DetailsDataDownload(int MasterID)
        {
            OracleProcedure procedure = new OracleProcedure(Utility.GetSchemaSetup_2(), "GetTableComDetailData");
            procedure.AddInputParameter("REPORTID", MasterID, OracleType.Number);
