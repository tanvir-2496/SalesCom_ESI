...
{
    public class Target_approval_ent
    {
        ...
        public Target_approval_ent()
        {

        }

        public Target_approval_ent(DataRow dr)
        {
            ...
            //if (dr["report_cycle_id"] != DBNull.Value) { this.report_cycle_id = Convert.ToInt16(dr["report_cycle_id"]); }
